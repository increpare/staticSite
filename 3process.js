...
var indexTemplate = '`'+fs.readFileSync('templates/3index.txt')+'`';
...
function doGrid(){
	...
	for (var i=0;i<table.length;i++){
        ...
        <img class="thumb" width="140px" height="140px" src="thumbs/${icon}"></p>`;
        	...
        	cardTemplate += `
		          <div class="container">
		            <a href="${html}" title="Play Now (HTML5)" alt="Play Now (HTML5)" >
		              <img width="30px" height="30px" class="icon" src="symbols/html5.svg" width="30px" height="30px">        
		              <div class="overlay">
        	...
        	cardTemplate += `
		          <div class="container">
		            <a href="${win}" title="Download for Windows" alt="Download for Windows" >
		              <img width="30px" height="30px" class="icon" src="symbols/windows.svg" width="30px" height="30px">        
		              <div class="overlay">
        	...
        	cardTemplate += `
		          <div class="container">
		            <a href="${mac}" title="Download for macOS" alt="Download for macOS" >
		              <img width="30px" height="30px" class="icon" src="symbols/apple.svg" width="30px" height="30px">        
		              <div class="overlay">
        	...
        	cardTemplate += `
		          <div class="container">
		            <a href="${linux}" title="Download for Linux" alt="Download for Linux" >
		              <img width="30px" height="30px" class="icon" src="symbols/linux.svg" width="30px" height="30px">        
		              <div class="overlay">
        	...
        	cardTemplate += `
		          <div class="container">
		            <a href="${flash}"  title="Play Online Now (Flash)" alt="Play Online Now (Flash)">
		              <img width="30px" height="30px" class="icon" src="symbols/flash.svg" width="30px" height="30px">        
		              <div class="overlay">
        ...
        if (zip!=""){
        	cardTemplate += `
		          <div class="container">
		            <a href="${zip}">
		              <img width="30px" height="30px" class="icon" title="Download Zip File" alt="Download Zip File" src="symbols/zip.svg" width="30px" height="30px">        
		              <div class="overlay">
        ...
        if (unity!=""){
        	cardTemplate += `
		          <div class="container">
		            <a href="${unity}">
		              <img width="30px" height="30px" class="icon" title="Play Online Now (Unity Web Player)" alt="Play Online Now (Unity Web Player)" src="symbols/unity.svg" width="30px" height="30px">        
		              <div class="overlay">
        ...
        if (src!=""){
        	cardTemplate += `
		          <div class="container">
		            <a href="${src}">
		              <img width="30px" height="30px" class="icon" title="Download Source Code (${src_desc})" alt="Download Source Code (${src_desc})" src="symbols/source.svg" width="30px" height="30px">        
		              <div class="overlay">
      	...
      	while (count<4){
      		// cardTemplate += `<div class="container"></div>`
      		count++;
			if (count%2===0){
				// cardTemplate+='<br>'
			}
